...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'slow_diffusion.core': {'slow_diffusion.core.foo': ('core.html#foo', 'slow_diffusion/core.py')},
            ...
            'slow_diffusion.fashionmnist': { 'slow_diffusion.fashionmnist.fashion_mnist_noisify': ( 'fashion_mnist.html#fashion_mnist_noisify',
            ...
            'slow_diffusion.model': { 'slow_diffusion.model.ConvBlock': ('model.html#convblock', 'slow_diffusion/model.py'),
                                      ...
                                      'slow_diffusion.model.timestep_embedding': ( 'model.html#timestep_embedding',
                                                                                   'slow_diffusion/model.py')},
            'slow_diffusion.training': { 'slow_diffusion.training.Config': ('training.html#config', 'slow_diffusion/training.py'),
                                         'slow_diffusion.training.TrainingConfig': ( 'training.html#trainingconfig',
                                                                                     'slow_diffusion/training.py'),
                                         'slow_diffusion.training.UnetConfig': ('training.html#unetconfig', 'slow_diffusion/training.py'),
